  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 no-print">
      <div className="max-w-2xl mx-auto px-4 py-8">
        ...
        {/* Editor Form - centered below card */}
          ...
          <div className="max-w-lg mx-auto space-y-5">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 rounded-xl bg-white/5 border border-white/10 text-white placeholder-white/30 focus:outline-none focus:border-pink-500/50 focus:bg-white/10 focus:ring-2 focus:ring-pink-500/20 transition-all duration-200"
              />
            </div>

            <div>
              <label className="block text-white/70 text-xs font-medium uppercase tracking-wider mb-2">Designation</label>
              <input
                type="text"
                value={data.title}
            ...
            <div>
              <label className="block text-white/70 text-xs font-medium uppercase tracking-wider mb-2">Phone</label>
              <input
                type="text"
                value={data.phone}
            ...
            <div>
              <label className="block text-white/70 text-xs font-medium uppercase tracking-wider mb-2">Email</label>
              <input
                type="text"
                value={data.email}
            ...
            <div>
              <label className="block text-white/70 text-xs font-medium uppercase tracking-wider mb-2">Website</label>
              <input
                type="text"
                value={data.website}
            ...
            <div>
              <label className="block text-white/70 text-xs font-medium uppercase tracking-wider mb-2">Tagline</label>
              <input
                type="text"
                value={data.tagline}
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full text-sm text-white/60 file:mr-4 file:py-2.5 file:px-5 file:rounded-xl file:border-0 file:text-sm file:font-medium file:bg-pink-500/20 file:text-pink-300 file:cursor-pointer hover:file:bg-pink-500/30 file:transition-all duration-200 cursor-pointer"
                />
              </div>
